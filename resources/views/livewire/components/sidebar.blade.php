<div dir="rtl">
    <div class="container g-0">
        <div class="sidebar">
        <p><strong>{{auth()->user()->name}} خوش آمدید</strong></p>
        <hr>
        <ul>
...
{{--            <li><a href=""><i class="fa fa-info"></i> test</a></li>--}}
            ...
            <div>
                <form action="{{ route('logout') }}" method="POST">
                    @csrf
{{--                    <button type="submit" class="btn btn-danger" style="width: 90% !important;">خروج</button>--}}
...
<script>
    ...
    // انتخاب تمام دکمه‌های خروج
    document.querySelectorAll('.logoutButton').forEach(button => {
        button.state = 'default'

        // تابع تغییر وضعیت دکمه از یک حالت به حالت دیگر
        ...
        // گوش دادن به hover ماوس روی دکمه
