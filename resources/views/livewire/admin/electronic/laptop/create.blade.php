        ...
        <div class="row g-0">
            ...
            <div class="col-md-10 content">
                ...
                <div class="container">
                    ...
                    <h5><i class="fa fa-arrow-alt-circle-left"></i> فرم ثبت تجهیزات الکترونیکی</h5>
                    <br>
                    <div class="row">

                        <div class="col-md-1"></div>
                        <div class="col-md-10 ">
                            <form wire:submit.prevent="save" class="form form-control">
                                <div class="row">
                                    <div class="col-md-6">
                                        <label>نام :</label><br>
                                        <select class="form form-control" wire:model="name">
                                        ...
                                        <label>برند :</label><br>
                                        <input type="text" class="form form-control" wire:model="brand">
                                        @error('brand') <span class="text-danger">{{ $message }}</span> @enderror
                                        <br>


                                        <label>شماره جمع داری :</label><br>
                                        <input type="text" class="form form-control" wire:model="serial_jam">
                                        @error('serial_jam') <span class="text-danger">{{ $message }}</span> @enderror
                                        <br>


                                        <label>شماره سریال IT :</label><br>
                                        <input type="text" class="form form-control" wire:model="serial_it">
                                        @error('serial_it') <span class="text-danger">{{ $message }}</span> @enderror
                                        <br>


                                        <label>Cpu :</label><br>
                                        <input type="text" class="form form-control" wire:model="cpu">
                                        @error('cpu') <span class="text-danger">{{ $message }}</span> @enderror
                                        <br>


                                        <label>Ram :</label><br>
                                        <input type="text" class="form form-control" wire:model="ram">
